...
# Windows 11 default = "Advanced"
# Options = ["Disabled"] ["Basic"] ["Advanced"]
$cloudBasedProtection = "Disabled"
# Settings -> Privacy & Security -> Windows Security -> Virus & threat protection -> Virus & threat protection settings -> Manage Settings -> Cloud-delivered protection
